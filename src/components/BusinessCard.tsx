...
import QRCode from "react-qr-code"; // Используем библиотеку для генерации QR-кода
...
// Функция для транскрипции кириллических символов в латиницу
...
export const BusinessCard: React.FC<BusinessCardProps> = ({ user }) => {
  ...
  // Формируем строку vCard с учетом транскрипции
...
END:VCARD`;
  ...
  console.log("vCard:", vCard); // Логируем строку vCard для проверки
